...
- Kyomi source (copy patterns from): `../kyomi` (sibling directory)
...
- `Cargo.toml`
- `crates/kyomi-core/src/db.rs`
- `crates/kyomi-core/src/kv_store.rs`
- `crates/kyomi-core/src/kv_store_redis.rs`
- `crates/kyomi-core/src/kv_store_memory.rs`
- `crates/kyomi-core/src/config.rs`
- `crates/kyomi-core/src/error.rs`
- `crates/kyomi-core/src/sql_compat.rs`
...
**Reference:** `crates/kyomi-types/src/`
...
**Reference files:**
- `crates/kyomi-ui/Trunk.toml`
- `crates/kyomi-ui/index.html`
- `crates/kyomi-ui/style/main.css`
- `crates/kyomi-ui/src/app.rs`
- `crates/kyomi-ui/src/lib.rs`
...
- `apps/server/src/leptos_frontend.rs`
...
**Reference files:**
- `crates/kyomi-auth/src/password.rs`
- `crates/kyomi-auth/src/jwt.rs`
- `crates/kyomi-auth/src/session.rs`
- `crates/kyomi-auth/src/auth_service.rs`
- `crates/kyomi-auth/src/cookies.rs`
- `crates/kyomi-auth/src/rate_limiter.rs`
...
**Reference:** `crates/kyomi-ui/src/server_fns/auth.rs`
...
**Reference files:**
- `crates/kyomi-ui-components/src/components/button.rs`
- `crates/kyomi-ui-components/src/components/modal.rs`
- `crates/kyomi-ui-components/src/components/toast.rs`
