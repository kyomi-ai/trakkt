...
pub fn create_access_token_str(
    ...
    .map_err(|e| trakkt_core::Error::Internal(format!("jwt encode: {e}")))
}
...
pub fn create_refresh_token() -> String {
    let prefix = &trakkt_core::constants::get().jwt.refresh_token_prefix;
...
pub fn validate_token(token: &str, secret: &str) -> trakkt_core::Result<TokenData<Claims>> {
    ...
    .map_err(|e| {
        ...
        trakkt_core::Error::Unauthorized(message)
    })
}
...
mod tests {
    ...
    fn refresh_token_is_opaque() {
        ...
        let _ = trakkt_core::constants::load_with_fallback();
