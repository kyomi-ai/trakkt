...
pub async fn exchange_code_for_tokens(
    ...
    code: &str,
    redirect_uri: &str,
) -> tane_core::Result<TokenResponse> {
    ...
    let resp = client
        ...
        .send()
        .await
        .map_err(|e| tane_core::Error::Internal(format!("Google token exchange failed: {e}")))?;
    ...
    resp.json::<TokenResponse>()
        .await
        .map_err(|e| tane_core::Error::Internal(format!("Failed to parse token response: {e}")))
}
...
pub async fn refresh_access_token(
    ...
    let resp = client
        ...
        .send()
        .await
        .map_err(|e| tane_core::Error::Internal(format!("Google token refresh failed: {e}")))?;
    ...
    resp.json::<TokenResponse>()
        .await
        .map_err(|e| tane_core::Error::Internal(format!("Failed to parse refresh response: {e}")))
}
...
pub async fn get_user_info(access_token: &str) -> tane_core::Result<GoogleUserInfo> {
    let client = crate::http_client()?;
    ...
    let resp = client
        ...
        .send()
        .await
        .map_err(|e| tane_core::Error::Internal(format!("Google userinfo request failed: {e}")))?;
    ...
    resp.json::<GoogleUserInfo>()
        .await
        .map_err(|e| tane_core::Error::Internal(format!("Failed to parse userinfo: {e}")))
}
...
pub fn parse_oauth_data(
    ...
    key: &[u8; 32],
) -> tane_core::Result<Option<OAuthData>> {
