...
use tane_core::{KVPool, kv_consume_json, kv_peek_json, kv_store_json};
...
pub async fn verify_oauth_state(
    ...
    provider: &str,
    state: &str,
) -> tane_core::Result<Option<serde_json::Value>> {
    let constants = tane_core::constants::get();
    let key = constants
        .redis
        .key_prefixes
...
pub async fn delete_webauthn_challenge(kv: &KVPool, challenge_id: &str) -> tane_core::Result<()> {
    let constants = tane_core::constants::get();
    let key = constants
        .redis
        .key_prefixes
...
pub async fn store_pending_totp(kv: &KVPool, user_id: &str, secret: &str) -> tane_core::Result<()> {
    let constants = tane_core::constants::get();
    let key = constants
        .redis
        .key_prefixes
...
pub async fn get_pending_totp(kv: &KVPool, user_id: &str) -> tane_core::Result<Option<String>> {
    let constants = tane_core::constants::get();
    let key = constants
        .redis
        .key_prefixes
...
pub async fn delete_recovery_session(kv: &KVPool, session_id: &str) -> tane_core::Result<()> {
    let constants = tane_core::constants::get();
    let key = constants
        .redis
        .key_prefixes
