...
use tane_core::{DbPool, RedisPool, WebSocketMessage};
use tokio::sync::mpsc;
...
impl WebSocketManager {
    ...
    pub fn connect(&self, user_id: &str) -> Result<(u64, mpsc::Receiver<String>), String> {
        ...
        let heartbeat = WebSocketMessage::new(tane_core::MessageType::Heartbeat);
    ...
    pub async fn broadcast_to_workspace(
        ...
        let members: Vec<(String,)> = match tane_core::db_fetch_all!(
            &self.inner.db,
            (String,),
